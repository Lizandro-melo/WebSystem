...
export default function RelatorioUnique() {
  ...
  return (
    <>
      <main className="bg-gray-100 h-screen flex flex-col w-screen !text-black">
          ...
          return (
            ...
            >
              ...
              <table className="w-full mb-6">
                <tbody>
                  <tr>
                    <td className="font-semibold pr-4">Nome do Colaborador:</td>
                    <td>
                      {
                  ...
                  <tr>
                    <td className="font-semibold pr-4">Data de Admissão:</td>
                    <td>
                      {formatarDataComum(
                        dadosSegundaVia.infoColaborador?.infoCLT?.dataAdmissao,
                      )}
                    </td>
                  </tr>
                  <tr>
                    <td className="font-semibold pr-4">Período Consultado:</td>
                    <td>
                      {formatarDataComum(dadosSegundaVia.dataInicial)} -{" "}
              ...
              <table className="w-full">
                <tbody>
                  <tr>
                    ...
                    <td>{dadosSegundaVia.dados?.horasPositivas} minutos</td>
                  </tr>
                  <tr>
                    <td className="font-semibold pr-4">Negativo do Mês:</td>
                    <td>{dadosSegundaVia.dados?.horasNegativas} minutos</td>
                  </tr>
                  <tr>
                    <td className="font-semibold pr-4">
                      Banco de horas (Todo o periodo):
                    </td>
                    <td>{dadosSegundaVia.dados?.bancoHoras} minutos</td>
                  </tr>
                </tbody>
              </table>
